...
class Receiver(nn.Module):
    def __init__(self, n_features, n_hidden):
        ...
        and game-specific input (_input) (e.g. matrix containing all input attribute-value vectors).
        ...
        The output dot prodoct list is interpreted as a non-normalized probability distribution 
    ...
    def forward(self, x, _input, _aux_input=None):
        ...
        #print(_input.shape) # [32, 20, 9]
        embedded_input = self.fc1(_input).tanh() # [32, 20, 256]
        #print(embedded_input.shape)
        dots = torch.matmul(embedded_input, torch.unsqueeze(x, dim=-1))
        #print(dots.squeeze().shape) # [32, 20]
        return dots.squeeze()
