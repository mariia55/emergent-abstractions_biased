...
srun /home/student/r/rverdugo/miniconda3/envs/eggfix/bin/python -m egg.nest.nest_local --game train --sweep grid_search/params167.json --n_workers=1 --root_dir "grid_search/167" --name "emergent-abstractions"
