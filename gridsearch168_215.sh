...
srun /home/student/r/rverdugo/miniconda3/envs/eggfix/bin/python -m egg.nest.nest_local --game train --sweep grid_search/params_168_215.json --n_workers=1 --root_dir "grid_search/168-215" --name "emergent-abstractions"
