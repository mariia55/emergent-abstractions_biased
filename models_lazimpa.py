...
class LazImpaSenderReceiverRnnGS(nn.Module):
    ...
    def forward(self, sender_input, labels, receiver_input=None, aux_input=None):
        ...
        for step in range(receiver_output.size(1)):
            ...
            #**************************
            # intensity of Rita et al.: beta2 = 10 == length_cost = 0.1; threshold = beta1 = 45
            step_length_pressure = self.length_cost * step_aux['acc']**self.threshold * (1.0 + step) # means eos is assumed as a symbol, therefore message (3,0,0,0) is calcuated like message length 2 !!!
